...
class StringAndroidAuthMessages {
  const StringAndroidAuthMessages({
...
String get androidFingerprintHint => Intl.message('Touch sensore',
...
String get androidCancelButton => Intl.message('Cancelar',
